...
#define SECP256K1_SILENTPAYMENTS_NUMBER_TESTVECTORS 26
...
static const struct bip352_test_vector bip352_test_vectors[SECP256K1_SILENTPAYMENTS_NUMBER_TESTVECTORS] = {
    ...
    /* ----- Multiple outputs with labels: un-labeled and labeled address; same recipient (16) ----- */
    {
        ...
        /* labels */
        1, {1, 0xffffffff, 0xffffffff, 0xffffffff, },
        /* expected output data (pubkeys and seckey tweaks) */
        2,
        {
            {0x39,0xf4,0x26,0x24,0xd5,0xc3,0x2a,0x77,0xfd,0xa8,0x0f,0xf0,0xac,0xee,0x26,0x9a,0xfe,0xc6,0x01,0xd3,0x79,0x18,0x03,0xe8,0x02,0x52,0xae,0x04,0xe4,0xff,0xcf,0x4c},
    ...
    /* ----- Multiple outputs with labels: un-labeled, labeled, and multiple outputs for labeled address; same recipients (18) ----- */
    {
        ...
        /* labels */
        2, {1, 1337, 0xffffffff, 0xffffffff, },
        /* expected output data (pubkeys and seckey tweaks) */
        4,
        {
            {0x00,0x6a,0x02,0xc3,0x08,0xcc,0xdb,0xf3,0xac,0x49,0xf0,0x63,0x8f,0x6d,0xe1,0x28,0xf8,0x75,0xdb,0x5a,0x21,0x30,0x95,0xcf,0x11,0x2b,0x3b,0x77,0x72,0x24,0x72,0xae},
    ...
    /* ----- Single recipient: use silent payments for sender change (19) ----- */
    {
        ...
        /* labels */
        1, {0, 0xffffffff, 0xffffffff, 0xffffffff, },
        /* expected output data (pubkeys and seckey tweaks) */
        1,
        {
            {0xbe,0x36,0x8e,0x28,0x97,0x9d,0x95,0x02,0x45,0xd7,0x42,0x89,0x1a,0xe6,0x06,0x40,0x20,0xba,0x54,0x8c,0x1e,0x2e,0x65,0xa6,0x39,0xa8,0xbb,0x06,0x75,0xd9,0x5c,0xff},
    ...
    /* ----- No valid inputs, sender generates no outputs (25) ----- */
    {
        ...
        { /* outputs to scan */
            {0x78,0x2e,0xeb,0x91,0x34,0x31,0xca,0x6e,0x9b,0x8c,0x2f,0xd8,0x0a,0x5f,0x72,0xed,0x20,0x24,0xef,0x72,0xa3,0xc6,0xfb,0x10,0x26,0x3c,0x37,0x99,0x37,0x32,0x33,0x38},
            {0xe0,0xec,0x4f,0x64,0xb3,0xfa,0x2e,0x46,0x3c,0xcf,0xcf,0x4e,0x85,0x6e,0x37,0xd5,0xe1,0xe2,0x02,0x75,0xbc,0x89,0xec,0x1d,0xef,0x9e,0xb0,0x98,0xef,0xf1,0xf8,0x5d},
        },
        /* labels */
        0, {0xffffffff, 0xffffffff, 0xffffffff, 0xffffffff, },
        /* expected output data (pubkeys and seckey tweaks) */
